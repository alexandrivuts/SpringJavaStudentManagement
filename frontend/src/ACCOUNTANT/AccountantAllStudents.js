...
import '../styles/AccountantAllStudents.css';

const AccountantAllStudents = () => {
    ...
    return (
        <div className="accountant-students-container">
            <Header />

            <div className="accountant-students-content">
                <AccountantSidebar activeSection={activeSection} setActiveSection={setActiveSection} />

                <div className="accountant-students-main">
...
export default AccountantAllStudents;
